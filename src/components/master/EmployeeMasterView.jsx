...
export default function EmployeeMasterView() {
  const { employees, departments, addEmployee, updateEmployee, deleteEmployee, showToast } = useDocumentControl();
      ...
      {isModalOpen && (
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Role Akses</label>
                <select
                  value={role}
                ...
                >
                  ...
                  <option value="approver">Approver / Verifikator</option>
                  <option value="doc_control">Document Control Officer</option>
